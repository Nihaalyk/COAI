...
__all__ = [
    'SPEI_TTS_AUDIO_LEVEL', 'SDA_Consume_Leading_Spaces',
    'SpeechPropertyResponseSpeed', 'DISPID_SVEPhoneme',
    'SRADefaultToActive', 'SpeechWordPronounceable',
    'SVESentenceBoundary', 'DISPID_SRCERecognizerStateChange',
    'tagSPPROPERTYINFO', 'SVP_13', 'SAFT24kHz8BitStereo',
    'SRAInterpreter', 'DISPID_SRSNumberOfActiveRules',
    'SPRST_INACTIVE', 'DISPID_SLGetGenerationChange',
    ...
    'SSFMCreateForWrite', 'DISPID_SASCurrentDevicePosition',
    'eLEXTYPE_PRIVATE6', 'SP_VISEME_9',
    ...
    'DISPID_SVESentenceBoundary', 'DISPID_SVEBookmark',
    'SRAORetainAudio', 'SPCS_ENABLED', 'SVSFPersistXML',
    'DISPID_SOTsItem', 'SPEI_RECOGNITION', 'DISPID_SCSBaseStream',
    'SPEI_RECO_STATE_CHANGE', 'SVSFIsNotXML', 'DISPID_SBSFormat',
    'SpeechRetainedAudioOptions', 'SAFTADPCM_11kHzMono',
    'DISPID_SGRAddResource', 'DISPID_SGRSTText',
    'DISPID_SGRSTransitions', 'DISPID_SMSALineId',
    'DISPID_SRCEStartStream', 'SAFT16kHz8BitMono', 'SpWaveFormatEx',
    'SAFT11kHz16BitStereo', 'DISPID_SDKCreateKey',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SPAs_NewEnum', 'SBONone',
    'SWPUnknownWordPronounceable', 'DISPID_SRGetFormat',
    'ISpRecognizer', 'SAFT22kHz16BitStereo',
    'DISPID_SpeechObjectToken', 'DISPID_SPIElements',
    'SPRECORESULTTIMES', 'DISPID_SGRSAddSpecialTransition',
    'SAFT48kHz8BitMono', 'ISpeechRecoContext', 'SITooLoud',
    'SPWF_SRENGINE', 'DISPID_SASetState', 'SpeechRecoEvents',
    'SpeechCategoryVoices', 'SP_VISEME_4', 'SPWORDPRONOUNCEABLE',
    'SPRECOCONTEXTSTATUS', 'DISPID_SRCEAdaptation',
    'SPGRAMMARWORDTYPE', 'DISPID_SRGetRecognizers',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'ISpeechObjectToken',
    'DISPID_SVEventInterests', 'DISPID_SRCBookmark',
    'eLEXTYPE_PRIVATE5', 'SAFTADPCM_8kHzMono', 'ISpNotifySink',
    'SPXRO_Alternates_SML', 'STCAll', 'ISpeechObjectTokenCategory',
    'SVEVoiceChange', 'SRTSMLTimeout', 'SPAUDIOSTATUS',
    'SpeechCategoryRecoProfiles', 'DISPID_SRSClsidEngine',
    'SAFT32kHz16BitMono', 'ISpeechDataKey', 'DISPID_SVSpeakStream',
    'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SSTTWildcard',
    'ISpeechPhraseReplacement', 'SPVISEMES', 'SPFM_CREATE',
    'ISpRecoCategory', 'ISpDataKey', 'SINoise',
    'DISPID_SRRAudioFormat', 'SPAR_High', 'DISPID_SLPs_NewEnum',
    'SPPHRASEPROPERTY', 'DISPID_SRRDiscardResultInfo',
    'SpeechDiscardType', 'DISPID_SpeechLexiconWord',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SpeechVoiceEvent',
    'ISpStreamFormatConverter', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SPEActualConfidence', 'SPFM_CREATE_ALWAYS',
    'DISPID_SGRInitialState', 'ISpXMLRecoResult', 'SPEI_TTS_PRIVATE',
    'DISPID_SpeechAudioStatus', 'SpeechDisplayAttributes',
    'DISPID_SRGReset', 'SPSNoun', 'SPPS_Function', 'SFTInput',
    'DISPID_SPIEnginePrivateData', 'SpeechGrammarTagWildcard',
    'SAFT44kHz16BitStereo', 'SVP_0', 'DISPID_SOTRemove',
    'SAFTADPCM_11kHzStereo', 'SREStreamStart', 'DISPID_SLWWord',
    ...
    'DISPID_SRRSpeakAudio', 'DISPID_SLPsItem',
    'ISpeechGrammarRuleStateTransitions', 'SAFT32kHz8BitStereo',
    'SPSModifier', 'SpMemoryStream', 'DISPID_SPRuleId', 'SPAS_CLOSED',
    'DISPID_SpeechVoice', 'ISpeechBaseStream',
    'SPINTERFERENCE_NOSIGNAL', 'SpeechGrammarState', 'SPWORD',
    'DISPID_SRCreateRecoContext', 'DISPID_SDKSetBinaryValue',
    'DISPID_SWFEBlockAlign', '_ISpeechVoiceEvents', 'IStream',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SRCEPhraseStart',
    'SAFTADPCM_44kHzMono', 'ISpObjectWithToken',
    ...
    'SpStreamFormatConverter', 'eLEXTYPE_PRIVATE19', 'SPSHORTCUTPAIR',
    'SpeechLoadOption', 'DISPID_SPRuleNumberOfElements',
    '_RemotableHandle', 'ISpeechLexiconPronunciation', 'ISpEventSink',
    'SPAUDIOSTATE', 'DISPID_SGRsCount', 'DISPID_SRGDictationUnload',
    'DISPID_SpeechRecoResult', 'ISpeechPhraseAlternates',
    'DISPID_SPPNumberOfElements', 'SRSInactiveWithPurge',
    'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SRGCmdSetRuleIdState', 'SECFNoSpecialChars',
    'SVSFVoiceMask', 'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SP_VISEME_5', 'DISPID_SGRSTWeight', 'SPPS_Verb',
    'DISPID_SMSGetData', 'SAFT22kHz8BitMono', 'ISpeechVoice',
    'SpLexicon', 'DISPID_SRCVoice', 'SREStateChange',
    'SECFIgnoreKanaType', 'DISPID_SPACommit', 'SREAudioLevel',
    'SAFT16kHz16BitMono', 'ISpeechPhraseInfoBuilder',
    'DISPID_SVSRunningState', 'SAFT16kHz8BitStereo',
    'SPEI_SOUND_START', 'SPSLMA', 'IInternetSecurityMgrSite',
    'ISpeechRecoResult', 'SREPropertyStringChange',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SRCEHypothesis',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SVGetAudioInputs',
    'WAVEFORMATEX', 'SPEVENTSOURCEINFO',
    'DISPID_SRSCurrentStreamNumber',
    'SpeechPropertyHighConfidenceThreshold', 'SVP_8',
    'SPRS_ACTIVE_USER_DELIMITED', 'eLEXTYPE_PRIVATE14',
    'SpeechDictationTopicSpelling', 'SPSUnknown', 'SPSHORTCUTTYPE',
    'SPAR_Low', 'SDTDisplayText', 'DISPID_SPRText', 'SPEVENT',
    'DISPID_SPIAudioStreamPosition', 'SpNotifyTranslator',
    'SPSHT_NotOverriden', 'SAFT8kHz16BitStereo', 'SPEI_RESERVED1',
    'DISPID_SPCLangId', 'SPSVerb', 'SLTUser', 'SpNullPhoneConverter',
    'STCInprocHandler', 'IInternetSecurityManager',
    'DISPID_SGRSTsCount', 'DISPID_SpeechPhraseProperty',
    'DISPID_SPERetainedStreamOffset', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SRRTTickCount', 'SGSEnabled', 'DISPID_SPAPhraseInfo',
    ...
    'eLEXTYPE_RESERVED6', 'ISpRecoContext2', 'SPEI_TTS_BOOKMARK',
    'DISPID_SpeechPhraseAlternates',
    'DISPID_SpeechLexiconPronunciation', 'SPPS_SuppressWord',
    'SGPronounciation', 'ISpStream', 'eLEXTYPE_RESERVED9',
    'SpeechAllElements', 'DISPID_SAFType', 'eLEXTYPE_PRIVATE13',
    'DISPID_SVEViseme', 'SAFTNoAssignedFormat', 'SRERequestUI',
    'SPVPRI_NORMAL', 'DISPID_SDKDeleteValue',
    'DISPID_SABufferNotifySize', 'SpeechTokenKeyAttributes',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SRGSetWordSequenceData',
    'SPSERIALIZEDPHRASE', 'DISPID_SPIRetainedSizeBytes',
    'ISpRecognizer2', 'SPRULESTATE', 'SpeechTokenKeyUI',
    'SPEI_START_SR_STREAM', 'SPAR_Medium', 'SpMMAudioEnum',
    'SVF_Stressed', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SRRAlternates', 'SSSPTRelativeToStart', 'SPPS_RESERVED1',
    'IEnumString', 'SPEI_SR_BOOKMARK', 'DISPID_SWFEBitsPerSample',
    'SDTAll', 'DISPID_SpeechLexiconProns', 'ISequentialStream',
    'DISPID_SPAsCount', 'DISPID_SAVolume', 'SVSFNLPSpeakPunc',
    'DISPID_SRGId', 'eLEXTYPE_PRIVATE4', 'SpeechCategoryRecognizers',
    'SRESoundStart', 'SAFT8kHz16BitMono', 'SAFT32kHz16BitStereo',
    'SPFILEMODE', 'SLOStatic', 'SPAR_Unknown', 'ISpProperties',
    'SPLO_STATIC', 'SPAUDIOBUFFERINFO', '__MIDL_IWinTypes_0009',
    'DISPID_SVGetProfiles', 'SVP_5', '_SPAUDIOSTATE',
    'SPDKL_LocalMachine', 'ISpeechPhraseInfo', 'SpeechInterference',
    'SpeechGrammarTagDictation', 'SFTSREngine',
    'DISPID_SVSLastBookmark', 'SPRST_NUM_STATES',
    'SPFM_OPEN_READONLY', 'DISPID_SLPType', 'SSTTDictation',
    'DISPID_SASNonBlockingIO', 'DISPID_SRRGetXMLErrorInfo',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SAFT32kHz8BitMono',
    'DISPID_SGRs_NewEnum', 'DISPID_SpeechGrammarRuleState',
    'ISpRecoResult', 'DISPID_SRIsShared', 'DISPID_SOTGetDescription',
    'DISPID_SpeechPhraseElement', 'SPWORDTYPE',
    'ISpeechXMLRecoResult', 'SVP_1', 'DISPID_SRCCmdMaxAlternates',
    'ISpeechAudioStatus', 'SPEI_SR_RETAINEDAUDIO',
    'SGDSActiveWithAutoPause', 'DISPID_SRCEFalseRecognition',
    'SpeechSpecialTransitionType', 'SPCS_DISABLED',
    'SPEI_WORD_BOUNDARY', 'SAFT44kHz8BitStereo', 'SpInprocRecognizer',
    'SP_VISEME_12', 'SGRSTTWord', 'SPWORDPRONUNCIATIONLIST',
    'SAFTCCITT_ALaw_11kHzMono', 'SDTAudio', 'SVP_12',
    'DISPID_SPIGrammarId', 'DISPID_SVWaitUntilDone', 'SpStream',
    'SP_VISEME_13', 'ISpNotifySource', 'SpSharedRecoContext',
    'DISPID_SABIBufferSize', 'DISPID_SWFEFormatTag', 'ISpMMSysAudio',
    'SpeechRecoContextState', 'SECHighConfidence', 'SPAS_PAUSE',
    'eLEXTYPE_PRIVATE17', 'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SRRecognizer', 'SAFT8kHz8BitStereo',
    'DISPID_SVSLastResult', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SVPriority', 'DISPID_SRGCommit', 'SPPHRASE',
    'SPEI_START_INPUT_STREAM', 'DISPID_SPRules_NewEnum',
    'SPEI_PHONEME', 'SECFIgnoreWidth', 'DISPID_SRGDictationLoad',
    'SPCONTEXTSTATE', 'eLEXTYPE_PRIVATE3',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SDA_Two_Trailing_Spaces',
    'DISPID_SpeechPhraseAlternate', 'STCLocalServer',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SPAsItem',
    'ISpeechTextSelectionInformation', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SGRSTs_NewEnum', 'SVSFParseMask',
    'SPEI_RECO_OTHER_CONTEXT', 'SpeechGrammarWordType',
    'DISPID_SOTDisplayUI', 'SPLOADOPTIONS', 'SREAllEvents',
    'DISPID_SPPEngineConfidence', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SOTCategory', 'SpAudioFormat', 'DISPID_SDKSetLongValue',
    'DISPID_SRCEBookmark', 'SPEI_PROPERTY_STRING_CHANGE',
    'ISpLexicon', 'SRTEmulated', 'SRTStandard',
    'DISPID_SRGIsPronounceable', 'SAFTGSM610_22kHzMono',
    ...
    'SVPNormal', 'SVSFlagsAsync', 'SPEI_VOICE_CHANGE',
    'ISpeechRecognizer', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SOTRemoveStorageFileName', 'SPCT_SUB_DICTATION',
    'SPEI_REQUEST_UI', 'SPPS_Noun', 'SAFTADPCM_8kHzStereo',
    'SPSSuppressWord', 'SVP_16', 'SPAS_RUN', 'Speech_Default_Weight',
    'SpeechRuleAttributes', 'DISPID_SGRsCommitAndSave',
    'SGSExclusive', 'DISPID_SOTCDefault', 'DISPID_SRRTimes',
    'DISPID_SPEAudioTimeOffset', 'SPBO_TIME_UNITS', 'SBOPause',
    ...
    'SPEI_INTERFERENCE', 'DISPID_SpeechPhraseBuilder', 'SPXRO_SML',
    'SDTLexicalForm', 'DISPID_SpeechRecognizer', 'SPSHT_EMAIL',
    'SP_VISEME_21', 'DISPID_SLWLangId', 'SPCT_DICTATION',
    'DISPID_SOTsCount', 'SAFT44kHz8BitMono', 'SP_VISEME_20',
    'DISPID_SDKSetStringValue',
    'SpeechPropertyNormalConfidenceThreshold', 'SPLEXICONTYPE',
    'SITooSlow', 'ISpeechPhraseProperty', 'ISpObjectToken',
    'SP_VISEME_17', 'SPPROPERTYINFO', 'DISPID_SAEventHandle',
    'DISPID_SGRSTPropertyValue', 'DISPID_SRGState',
    'ISpeechGrammarRules', 'ISpAudio', 'SAFT16kHz16BitStereo',
    'DISPID_SPRDisplayAttributes', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SPRulesItem', 'DISPID_SVEAudioLevel', 'SGRSTTDictation',
    'DISPID_SGRsItem', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SpeechFileStream', 'SAFT11kHz16BitMono',
    'DISPID_SVEEnginePrivate', 'DISPID_SVPause',
    'DISPID_SDKGetlongValue', 'eLEXTYPE_RESERVED10',
    'SpeechMicTraining', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SpeechPhraseElements', 'eLEXTYPE_PRIVATE7',
    'DISPID_SGRSTsItem', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'eLEXTYPE_PRIVATE20', 'DISPID_SRCEventInterests',
    'ISpeechLexiconWord', 'SAFT22kHz8BitStereo', 'DISPID_SLGetWords',
    'DISPID_SRRTStreamTime', 'DISPID_SPARecoResult', 'SWTDeleted',
    'DISPID_SPRuleChildren', 'SAFT12kHz8BitMono',
    'SPRST_ACTIVE_ALWAYS', 'ISpStreamFormat', 'DISPID_SLPSymbolic',
    'DISPID_SOTGetAttribute', 'SPPARTOFSPEECH', 'SpShortcut',
    'DISPID_SGRClear', 'DISPID_SLRemovePronunciation',
    'DISPID_SVEStreamEnd', 'DISPID_SASState', 'SPINTERFERENCE',
    'SVEWordBoundary', 'DISPID_SpeechXMLRecoResult', 'DISPID_SOTCId',
    'DISPID_SRGCmdLoadFromObject', 'SVP_7', 'SVP_15',
    'SPADAPTATIONRELEVANCE', 'SpeechBookmarkOptions',
    'SGDSActiveUserDelimited', 'SRARoot', 'SAFTCCITT_ALaw_44kHzMono',
    'SRAExport', 'SAFTADPCM_22kHzStereo', 'ISpeechMMSysAudio',
    'SVP_10', 'SPVPRI_ALERT', 'SpeechAudioFormatGUIDText',
    'SSTTTextBuffer', 'ISpVoice', 'SAFT22kHz16BitMono',
    'SAFTTrueSpeech_8kHz1BitMono', 'SRATopLevel',
    'SECNormalConfidence', 'DISPID_SPRulesCount',
    'DISPID_SPRNumberOfElements', 'SpCustomStream', 'SP_VISEME_19',
    'SPWT_LEXICAL', 'ISpeechResourceLoader', 'DISPID_SDKEnumKeys',
    'DISPID_SPRFirstElement', 'SVSFNLPMask', 'DISPID_SBSRead',
    'DISPID_SRCSetAdaptationData', 'SVEPhoneme',
    'ISpeechPhoneConverter', 'Speech_StreamPos_RealTime',
    'DISPID_SRGCmdLoadFromFile', 'SpeechRecognitionType',
    'DISPID_SASFreeBufferSpace', 'SPCT_COMMAND', 'STCRemoteServer',
    'eLEXTYPE_PRIVATE12', 'ISpeechPhraseElement', 'SPSFunction',
    'SDKLCurrentConfig', 'SPGS_EXCLUSIVE', 'DISPID_SRCEEndStream',
    'SpeechCategoryAppLexicons', 'SpeechPropertyComplexResponseSpeed',
    'DISPID_SGRSTPropertyId', 'DISPID_SGRsAdd',
    'DISPIDSPTSI_ActiveLength', 'SpeechDataKeyLocation',
    'SRERecognition', 'SPEI_UNDEFINED', 'SPEI_RESERVED5',
    'ISpeechPhraseReplacements', 'SPPS_LMA', 'SASClosed',
    'SRADynamic', 'DISPID_SAStatus', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SLPLangId', 'SVP_2', 'SPBO_PAUSE',
    'DISPID_SVAudioOutputStream', 'DISPID_SVSPhonemeId',
    'SAFTExtendedAudioFormat', 'DISPIDSPTSI_SelectionOffset',
    'SVSFUnusedFlags', 'DISPID_SBSWrite', 'DISPID_SPPs_NewEnum',
    ...
    'DISPID_SPIProperties', 'DISPID_SPELexicalForm',
    'SDA_No_Trailing_Space', 'DISPID_SVEWord', 'SP_VISEME_14',
    'SPSHT_Unknown', 'SPRST_ACTIVE', 'DISPID_SGRsCommit',
    'DISPID_SPEPronunciation',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SLPPartOfSpeech',
    'SPSTREAMFORMATTYPE', 'SPGS_DISABLED', 'SpeechAudioVolume',
    'DISPID_SPIGetText', 'DISPID_SDKGetBinaryValue',
    'DISPID_SOTCSetId', 'ISpeechPhraseProperties',
    'DISPID_SMSADeviceId', 'SPSNotOverriden', 'DISPID_SPRuleParent',
    'DISPID_SOTId', 'DISPID_SGRSTType', 'SPVPRI_OVER',
    'DISPID_SRRPhraseInfo', 'DISPID_SRAudioInput', 'SAFT8kHz8BitMono',
    'SpeechAudioFormatType', 'eLEXTYPE_APP', 'SVP_18',
    'DISPID_SRSetPropertyNumber', 'DISPID_SOTCGetDataKey',
    'DISPID_SVSpeak', 'SECLowConfidence', 'SVP_3',
    ...
    'DISPID_SpeechPhraseRule', 'SECFIgnoreCase', 'ISpRecoContext',
    'SGRSTTWildcard', 'SAFT48kHz16BitMono',
    'DISPID_SLAddPronunciation', 'SAFTCCITT_uLaw_44kHzMono',
    'SRTExtendableParse', 'ISpPhoneConverter', 'SVSFIsFilename',
    'DISPID_SpeechRecoResult2', 'DISPID_SRCState', 'SPPS_Unknown',
    'DISPID_SVVoice', 'SpCompressedLexicon', 'DISPID_SRState',
    'SSSPTRelativeToEnd', 'DISPID_SVSLastBookmarkId',
    'SpeechCategoryAudioIn', 'SREPhraseStart',
    'ISpeechAudioBufferInfo', 'DISPID_SpeechRecoContext',
    'SPEI_END_SR_STREAM', 'SP_VISEME_11', 'SpInProcRecoContext',
    'eLEXTYPE_PRIVATE18', 'SpeechRegistryUserRoot', 'SRSInactive',
    ...
    'SPEI_PHRASE_START', 'SPPS_RESERVED4', 'SVP_4', 'SPEI_MIN_SR',
    'DISPID_SRGetPropertyNumber', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SPIEngineId', 'DISPID_SPISaveToMemory', 'SP_VISEME_16',
    'SpeechVisemeFeature', 'SVF_None', 'SAFTGSM610_44kHzMono',
    'DISPID_SPEsCount', 'DISPID_SPPId', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SpeechRecoResultTimes', 'SPEI_RESERVED3', 'SpObjectToken',
    'UINT_PTR', 'DISPID_SpeechObjectTokens', 'eLEXTYPE_PRIVATE10',
    'SpVoice', 'DISPID_SMSAMMHandle', 'DISPID_SPEs_NewEnum',
    'ISpShortcut', 'SGDisplay', 'SAFT48kHz8BitStereo',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SVAudioOutput',
    'SPWT_PRONUNCIATION', 'SpeechStreamSeekPositionType',
    'SGDSInactive', 'SAFT12kHz16BitStereo', 'SPDKL_DefaultLocation',
    'ISpEventSource', 'DISPID_SPPFirstElement',
    'DISPID_SRSAudioStatus', 'DISPID_SLPPhoneIds',
    'SPBOOKMARKOPTIONS', 'DISPID_SVSInputWordLength',
    'SPFM_NUM_MODES', 'IEnumSpObjectTokens', 'SPEI_VISEME',
    'SVEPrivate', 'DISPID_SLGenerationId', 'SGRSTTRule',
    'SpeechAudioState', 'SRSActive', 'DISPID_SpeechRecognizerStatus',
    'ISpeechPhraseRule', 'SRSEIsSpeaking',
    'DISPID_SAFSetWaveFormatEx', 'SPWORDPRONUNCIATION',
    'SVSFPurgeBeforeSpeak', 'SDKLDefaultLocation',
    'DISPID_SRCRequestedUIType', 'SAFTGSM610_11kHzMono',
    'SPFM_OPEN_READWRITE', 'SPPS_RESERVED3', 'SPINTERFERENCE_NONE',
    'DISPID_SMSSetData', 'SpeechTokenIdUserLexicon',
    'SpUnCompressedLexicon', 'DISPID_SpeechGrammarRule',
    'SECFEmulateResult', 'SLTApp', 'SVP_19', 'DISPID_SVDisplayUI',
    'DISPID_SGRsFindRule', 'ISpResourceManager', 'SWTAdded',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SDKDeleteKey',
    'DISPID_SOTDataKey', 'SAFT12kHz16BitMono', 'SAFTGSM610_8kHzMono',
    'SPTEXTSELECTIONINFO', 'SP_VISEME_15', 'SPPHRASEREPLACEMENT',
    'DISPID_SpeechWaveFormatEx', 'ISpGrammarBuilder', 'SpMMAudioOut',
    'SpTextSelectionInformation', 'SVSFDefault', 'SVP_20',
    'DISPID_SRCResume', 'SP_VISEME_10', 'DISPID_SVEVoiceChange',
    'DISPID_SGRSRule', 'SVP_9', 'SDA_One_Trailing_Space',
    'SPEVENTENUM', 'DISPID_SGRName', 'SPCT_SLEEP',
    ...
    'SpPhraseInfoBuilder', 'ISpRecoGrammar2', 'SpObjectTokenCategory',
    'SASPause', 'SpeechVoicePriority', 'DISPID_SpeechAudioFormat',
    'SREStreamEnd', 'SDKLLocalMachine', 'SAFTCCITT_uLaw_8kHzMono',
    'SAFTCCITT_uLaw_11kHzMono', 'SPEI_RESERVED6',
    'DISPID_SOTGetStorageFileName', 'DISPID_SPRsCount', 'SPWORDLIST',
    'SPPHRASERULE', 'DISPID_SPPName', 'SWPKnownWordPronounceable',
    'DISPID_SDKGetStringValue', 'SPRS_ACTIVE', 'SpeechUserTraining',
    'ISpeechLexiconPronunciations', 'SGRSTTEpsilon',
    'DISPID_SGRSTNextState', 'ISpRecoGrammar',
    'SpeechCategoryAudioOut', 'SREPrivate', 'DISPID_SABIEventBias',
    'DISPID_SPERetainedSizeBytes',
    'DISPID_SRCERecognitionForOtherContext', 'SAFTDefault',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPEI_RESERVED2', 'SSFMCreate', 'DISPID_SpeechPhraseReplacements',
    'SpeechVoiceEvents', 'ISpPhoneticAlphabetSelection',
    'DISPID_SPEsItem', 'SpeechTokenShellFolder', 'SPBO_AHEAD',
    'SPINTERFERENCE_TOOQUIET', 'SPSHT_OTHER', 'SPGRAMMARSTATE',
    'DISPID_SPPValue', 'DISPID_SRCEAudioLevel', 'SpSharedRecognizer',
    'SASRun', 'ISpeechAudio', 'SPWF_INPUT', 'SPPS_RESERVED2',
    'DISPID_SABufferInfo', 'DISPID_SPEEngineConfidence',
    'STSF_LocalAppData', 'SP_VISEME_8', 'DISPID_SRAudioInputStream',
    'SPPS_NotOverriden', 'DISPID_SRCRetainedAudio',
    'DISPID_SGRSAddWordTransition', 'SSFMOpenForRead',
    'SpeechRuleState', 'SAFTADPCM_22kHzMono', 'ISpeechPhraseElements',
    'DISPID_SPRuleConfidence', 'DISPID_SOTCreateInstance',
    'SRCS_Enabled', 'SpeechLexiconType',
    'DISPID_SPERequiredConfidence', 'DISPID_SPIReplacements',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SRCERequestUI',
    'SpeechVisemeType', 'DISPID_SpeechPhraseInfo',
    'ISpeechGrammarRule', 'SPDKL_CurrentUser', 'SpeechRunState',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SPRuleFirstElement',
    'SPEI_PROPERTY_NUM_CHANGE', 'SVEStartInputStream',
    'DISPID_SRCEInterference', 'ISpeechRecoGrammar',
    'DISPID_SGRSTRule', 'SpeechCategoryPhoneConverters', 'SRAImport',
    'DISPID_SRCRecognizer', 'SpeechAudioProperties',
    'ISpeechObjectTokens', 'SVSFParseSsml', 'SPINTERFERENCE_TOOLOUD',
    'SpPhoneticAlphabetConverter', 'SP_VISEME_3',
    'eLEXTYPE_PRIVATE15', 'SPCATEGORYTYPE',
    'DISPID_SOTCEnumerateTokens', 'SpPhoneConverter',
    'DISPID_SLWsItem', 'DISPID_SBSSeek', 'SAFT24kHz16BitStereo',
    'DISPID_SVIsUISupported', 'ISpeechCustomStream',
    'SAFT24kHz8BitMono', 'DISPID_SABIMinNotification', 'DISPIDSPRG',
    'SREBookmark', 'SAFT44kHz16BitMono', 'DISPID_SVVolume',
    'SVSFParseSapi', 'SREFalseRecognition', 'SpeechVoiceSpeakFlags',
    'DISPID_SRCESoundEnd', 'SpeechAudioFormatGUIDWave',
    '_ISpeechRecoContextEvents', 'DISPID_SGRsDynamic', 'SPAS_STOP',
    'DISPID_SVSInputSentenceLength', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SOTIsUISupported', 'SVF_Emphasis', 'DISPID_SDKOpenKey',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SRRRecoContext',
    'SPEI_SENTENCE_BOUNDARY', 'SPEI_FALSE_RECOGNITION', 'ISpPhrase',
    'SpeechTokenKeyFiles', 'SREAdaptation', 'DISPID_SRCESoundStart',
    'SVP_21', 'SVPOver', 'DISPID_SPPParent', 'ISpeechFileStream',
    'DISPID_SLGetPronunciations', 'DISPID_SGRSTPropertyName',
    'ISpeechPhraseAlternate', 'SRTAutopause',
    'DISPID_SpeechGrammarRules', 'SPWT_DISPLAY',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPIDSPTSI', 'STCInprocServer',
    'SPRS_INACTIVE', 'DISPID_SVSVisemeId', 'DISPID_SFSClose',
    'DISPID_SWFESamplesPerSec', 'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SWFEChannels', 'DISPID_SLPsCount', 'DISPID_SpeechDataKey',
    'DISPID_SPRs_NewEnum', 'ISpeechRecoResultDispatch',
    'SVEAudioLevel', 'SDTPronunciation',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SOTMatchesAttributes',
    'DISPID_SGRAttributes', 'SAFT11kHz8BitStereo', 'SVSFIsXML',
    'SPEI_MAX_SR', 'ISpeechLexicon',
    'SpeechPropertyLowConfidenceThreshold',
    'SpeechEmulationCompareFlags', 'SPSMF_UPS',
    'DISPID_SRRGetXMLResult', 'SRTReSent',
    'SAFTCCITT_uLaw_22kHzStereo', 'SDTReplacement',
    'SPSHORTCUTPAIRLIST', 'SPRECOSTATE', 'DISPID_SOTs_NewEnum',
    'SITooFast', 'SPGS_ENABLED', 'STSF_AppData',
    'DISPIDSPTSI_SelectionLength', 'SPBINARYGRAMMAR',
    'DISPID_SVResume', 'SDTAlternates', 'SRESoundEnd',
    'DISPID_SRDisplayUI', 'ISpeechRecoResult2', 'ISpeechLexiconWords',
    'DISPID_SDKEnumValues', 'SPAO_NONE', 'eLEXTYPE_PRIVATE1',
    'DISPID_SREmulateRecognition', 'DISPID_SRCPause',
    'SSFMOpenReadWrite', 'DISPID_SAFGuid', 'DISPID_SVGetAudioOutputs',
    'SAFT12kHz8BitStereo', 'SPSEMANTICFORMAT',
    'SPRST_INACTIVE_WITH_PURGE', 'eLEXTYPE_RESERVED8',
    'ISpeechMemoryStream', 'DISPID_SPIAudioSizeTime',
    'Speech_StreamPos_Asap', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SVSkip', 'DISPID_SpeechPhoneConverter', 'DISPID_SRRAudio',
    'DISPID_SOTSetId', 'ISpeechVoiceStatus',
    'DISPID_SpeechAudioBufferInfo', 'SpeechPartOfSpeech',
    'ISpSerializeState', 'SGSDisabled', 'SASStop',
    'DISPID_SRRSaveToMemory', 'DISPID_SRGRecoContext',
    'SPVOICESTATUS', 'SDKLCurrentUser', 'SVP_14', 'SVEAllEvents',
    'DISPID_SpeechGrammarRuleStateTransition', 'DISPID_SWFEExtraData',
    'DISPID_SLWsCount', 'SPEI_HYPOTHESIS', 'SAFT24kHz16BitMono',
    'DISPID_SPRsItem', 'eLEXTYPE_PRIVATE9', 'SPPS_Interjection',
    'eLEXTYPE_MORPHOLOGY', 'SpeechPropertyResourceUsage',
    'SP_VISEME_0', 'SVEViseme', 'SVPAlert',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SPEAudioSizeTime',
    'SP_VISEME_6', 'SVP_6', 'ISpNotifyTranslator',
    'eLEXTYPE_PRIVATE16', 'STSF_FlagCreate',
    'DISPID_SRGCmdLoadFromResource', 'SpeechRecognizerState',
    'eLEXTYPE_PRIVATE8', 'SP_VISEME_18', 'SPDKL_CurrentConfig',
    'LONG_PTR', 'DISPID_SPEDisplayText', 'Speech_Max_Pron_Length',
    'DISPID_SPIRule', 'DISPID_SpeechPhraseRules',
    'DISPID_SpeechLexicon', 'SpFileStream', 'DISPID_SVStatus',
    'SECFDefault', 'SpeechAddRemoveWord', 'DISPID_SRCEEnginePrivate',
    'DISPID_SRProfile', 'SAFT11kHz8BitMono', 'SAFTText',
    'SPRECOGNIZERSTATUS', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SRCEPropertyStringChange', 'eWORDTYPE_ADDED',
    'DISPID_SPCIdToPhone', 'SPEI_SOUND_END', 'SGDSActive',
    'SAFTCCITT_ALaw_8kHzStereo', 'Speech_Max_Word_Length',
    'SPEI_END_INPUT_STREAM', 'ISpeechAudioFormat',
    'DISPID_SRRTLength', 'SAFTCCITT_ALaw_22kHzMono', 'SPPS_Modifier',
    'SRCS_Disabled', 'SPSERIALIZEDRESULT', 'SpeechStreamFileMode',
    'SVEEndInputStream', 'SRSEDone', 'STSF_CommonAppData',
    'SPSInterjection', 'SPAO_RETAIN_AUDIO', 'SP_VISEME_1',
    'ISpeechPhraseRules', 'DISPID_SPPsCount', 'SPINTERFERENCE_NOISE',
    'DISPID_SPCPhoneToId', 'SPSMF_SAPI_PROPERTIES', 'DISPID_SRGRules',
    'SINone', 'DISPID_SpeechCustomStream', 'SREHypothesis',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SpeechBaseStream',
    'SWPUnknownWordUnpronounceable', 'SAFTADPCM_44kHzStereo',
    'SAFTCCITT_uLaw_44kHzStereo', 'SITooQuiet', 'DISPID_SGRId',
    'eLEXTYPE_RESERVED4', 'tagSTATSTG', 'DISPID_SGRAddState',
    'SREPropertyNumChange', 'SINoSignal', 'ISpRecognizer3',
    'SPEI_MAX_TTS', 'DISPID_SVRate', 'SREInterference',
    'DISPID_SPIStartTime', 'ISpeechGrammarRuleState',
    'DISPID_SWFEAvgBytesPerSec', 'SVP_17',
    'DISPID_SPEDisplayAttributes', 'SpeechTokenContext',
    'DISPID_SpeechLexiconWords', 'DISPID_SVSInputWordPosition',
    'SGLexical', 'SPDATAKEYLOCATION', 'SpeechPropertyAdaptationOn',
    'SDTRule', 'SPBO_NONE', 'ISpPhraseAlt', 'SPEI_SR_PRIVATE',
    'SRAONone', 'SpMMAudioIn', 'SPXMLRESULTOPTIONS', 'SPEI_MIN_TTS',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'tagSPTEXTSELECTIONINFO', 'SP_VISEME_2', 'DISPID_SLWs_NewEnum',
    'SPAUDIOOPTIONS', 'DISPID_SPPChildren',
    'DISPID_SVSLastStreamNumberQueued', 'SpeechWordType',
    'SpeechFormatType', 'SPVPRIORITY',
    'DISPID_SpeechObjectTokenCategory', 'SPPS_Noncontent',
    'DISPID_SRGetPropertyString', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SRIsUISupported', 'eLEXTYPE_PRIVATE2',
    'SVSFParseAutodetect', 'SRERecoOtherContext', 'SP_VISEME_7'
]
